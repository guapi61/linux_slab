...
#define LV_USE_FS_STDIO 1
    ...
    #define LV_FS_STDIO_PATH "/mnt/app/my_project/build/"           /*Set the working directory. File/directory paths will be appended to it.*/
...
#define LV_USE_FS_POSIX 1
    ...
    #define LV_FS_POSIX_PATH "/mnt/app/my_project/build/"         /*Set the working directory. File/directory paths will be appended to it.*/
